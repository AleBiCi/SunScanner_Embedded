...
void setup_menu(){
    ...
    MAP_ADC14_enableModule();    MAP_ADC14_initModule(ADC_CLOCKSOURCE_ADCOSC, ADC_PREDIVIDER_32, ADC_DIVIDER_8, 0);
    /* Configuring ADC Memory (ADC_MEM0 - ADC_MEM1 (A15, A9)  with repeat)
     * with internal 2.5v reference */    MAP_ADC14_configureMultiSequenceMode(ADC_MEM0, ADC_MEM2, true);
     ...
     /* Triggering the start of the sample */    MAP_ADC14_enableConversion();
     MAP_ADC14_toggleConversionTrigger();
     alt1Prev = alt1;
     alt2Prev = alt2;    depthPrev = depth;
     /* STARTUP ANIMATION */
     //const Graphics_Image* frame_list[7] = {&frame1_UNCOMP, &frame2_UNCOMP, &frame3_UNCOMP, &frame4_UNCOMP, &frame5_UNCOMP, &frame6_UNCOMP, &frame7_UNCOMP};    //startupAnimation(&g_sContext, frame_list, 7);
     selMenu(1, 1, 1);
